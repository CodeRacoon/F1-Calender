...
const zoneJss = theme => ({
    ...
    '@keyframes clickEffect': {
        "0%" : {textShadow: "-0.03rem 0.03rem 0px rgba(0,0,0,1), 0.03rem -0.03rem 0px rgba(0,0,0,1),-0.09rem 0.09rem 0px rgba(255,0,100,1), -0.18rem 0.18rem 0px rgba(0,255,200,1), -0.27rem 0.27rem 0px rgba(0,255,200,1)",},
        "25%" : {color: "rgba(0,0,0,0)", textShadow: "-0.03rem 0.03rem 0px rgba(255,255,255,1), 0.03rem -0.03rem 0px rgba(255,255,255,1),-0.09rem 0.09rem 0px rgba(255,0,100,1), -0.18rem 0.18rem 0px rgba(0,255,200,1), -0.27rem 0.27rem 0px rgba(0,255,200,1)",},
        "50%" : {color: "rgba(0,0,0,0)", textShadow: "-0.03rem 0.03rem 0px rgba(0,0,0,0), 0.03rem -0.03rem 0px rgba(0,0,0,0),-0.09rem 0.09rem 0px rgba(255,255,255,1), -0.18rem 0.18rem 0px rgba(0,255,200,1), -0.27rem 0.27rem 0px rgba(0,255,200,1)",},
        "75%" : {color: "rgba(0,0,0,0)", textShadow: "-0.03rem 0.03rem 0px rgba(0,0,0,0), 0.03rem -0.03rem 0px rgba(0,0,0,0),-0.09rem 0.09rem 0px rgba(255,0,100,0), -0.18rem 0.18rem 0px rgba(255,255,255,1), -0.27rem 0.27rem 0px rgba(0,255,200,1)",},
        "100%" : {color: "rgba(0,0,0,0)", textShadow: "-0.03rem 0.03rem 0px rgba(0,0,0,0), 0.03rem -0.03rem 0px rgba(0,0,0,0),-0.09rem 0.09rem 0px rgba(255,0,100,0), -0.18rem 0.18rem 0px rgba(0,255,200,0), -0.27rem 0.27rem 0px rgba(255,255,255,1)",},
